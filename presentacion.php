...
<head>
    ...
    <title>Presentación - Programa de Diseño y Programación Web</title>
    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .content-section, .curriculum-section {
                padding: 60px 40px;
            }
    ...
    <div class="container">
        <section class="hero-section">
            <div class="hero-content">
                <h1 class="hero-title">Programa de Diseño y Programación Web</h1>
